...
{
    public class KategorilerAdminController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,MakaleId,KategoriAd")] Kategori kategori)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,MakaleId,KategoriAd")] Kategori kategori)
        {
            if (ModelState.IsValid)
            {
